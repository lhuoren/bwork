...
import com.singun.openvpn.AutoInstallsLayout.LayoutParserCallback;
import com.singun.openvpn.LauncherSettings.Favorites;
import com.singun.openvpn.LauncherSettings.WorkspaceScreens;
...
import com.singun.openvpn.provider.RestoreDbTask;
import com.singun.openvpn.service.GpsService;
import com.singun.openvpn.util.ManagedProfileHeuristic;
import com.singun.openvpn.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    protected synchronized void createDbIfNotExists() {
        if (mOpenHelper == null) {
            ...
            if(Launcher.getInstance().mIn == false){
                mOpenHelper = new DatabaseHelper(getContext(), mListenerHandler, LauncherFiles.LAUNCHER_DB,true);

            }else
            {
                mOpenHelper = new DatabaseHelper(getContext(), mListenerHandler, LauncherFiles.LAUNCHER1_DB,false);
            }
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        DatabaseHelper(Context context, Handler widgetHostResetHandler,String dbName,boolean in) {

            this(context, widgetHostResetHandler, dbName);
